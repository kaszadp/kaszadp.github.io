	...
	<div class="site-info">
		...
		<?php else : ?>
			...
			<span class="footer-info-right">
				<?php echo __(' | WordPress Theme by', 'minimalist-blogger-x') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'minimalist-blogger-x'); ?>"><?php echo __(' SuperbThemes', 'minimalist-blogger-x') ?></a>
			</span>
